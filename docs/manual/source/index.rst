.. xp documentation master file, created by
...
xp seeks to address a fundamental issue that haunts every brand of
...
xp makes it easy to create and update workflows (called pipelines) while
